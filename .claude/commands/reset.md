...
- `.claude/skills/job-application-assistant/06-interview-prep.md` *(STAR examples and STAR candidates sections only — framework structure is preserved)*
...
- 05-cv-templates.md — [has profile statements / already blank]
  Profile statement templates will be cleared. Structure and tailoring guidelines are preserved.

- 06-interview-prep.md — [has STAR examples / already blank]
...
**For `06-interview-prep.md`**, locate and remove:
...
Leave all other content in `06-interview-prep.md` intact (STAR format explanation, tough questions, questions to ask interviewers, phone/video tips, follow-up etiquette, roleplay guidelines).
